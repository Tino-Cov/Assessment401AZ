        ...
        private void UPDATE_Click(object sender, EventArgs e)
        {
            if (dataGridViewProjectFiles.SelectedRows.Count > 0)
            {
                ...
                if (selectedProjectFiles != null)
                {
                    ...
                    selectedProjectFiles.ProjectStart = txtProjectStart.Text;
                    selectedProjectFiles.ProjectEnd = txtProjectEnd.Text;
                    selectedProjectFiles.EngineerID = txtEngineerID.Text;
                    selectedProjectFiles.ManagerID = txtManagerID.Text;
